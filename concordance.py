...
def build_concordance(naics6_list):
    """
    ...
    print(f"Concordance built: {n_mapped}/{n_total} NAICS6 codes mapped to BEA IO industries")
    print(f"  Out of scope (services/unmapped): {n_unmapped} codes")
    print(f"  BEA IO industries covered: {concordance['bea_io'].nunique() - 1}")
